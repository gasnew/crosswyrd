...
export default function WelcomeDialog({ open, onClose }: Props) {
  return (
    ...
    >
      ...
      <DialogContent dividers className="sheet" style={{ margin: 12 }}>
        ...
        <div>
          ...
          <KeyboardMapping
            ...
            description="Place/Remove letter tile"
          />
          <KeyboardMapping keys={<kbd>↑</kbd>} description="Move selection" />
        </div>
